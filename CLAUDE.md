...
| [docs/web/README.md](docs/web/README.md) | Built-in web UI: what it is, auth, env, deploy, architecture (this fork's in-tree channel) |
| [docs/web/USAGE.md](docs/web/USAGE.md) | Web UI end-user guide: the wizard, chat surface, rooms, the ⚙ management drawer, access |
